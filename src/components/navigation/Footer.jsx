...
const Footer = () => {
  ...
  useEffect(() => {
    // Footer background
    preloadImage("/assets/footer/footer-bg.svg");

    // Logo
    preloadImage("/assets/navbar/inide-grage-logo.svg");

    // Nav text images used in footer
    const footerNavImages = [
      "/assets/navbar/home.png",
      "/assets/navbar/review.png",
      "/assets/navbar/services.png",
      "/assets/navbar/work.png",
      "/assets/navbar/contact.png",
    ];

    footerNavImages.forEach(preloadImage);

    // Social icons
    preloadImage("/assets/footer/linkedin.png");
    preloadImage("/assets/footer/youtube.png");
    preloadImage("/assets/footer/insta.png");
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        <div className="relative z-10 w-full mx-auto h-full grid xl:grid-cols-[450px_1fr] 2xl:grid-cols-[550px_1fr]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="grid grid-cols-3 items-start h-[0px]">
              <div className="flex justify-start mt-5 2xl:ml-10 2xl:-mt-10 cursor-pointer">
                <Image
                  ...
                  width={220}
                  height={90}
                  className="w-[140px] md:w-[170px] xl:w-[130px] 2xl:w-[170px] h-auto"
                />
              </div>
              ...
              <div className="flex justify-start -ml-8 mt-5 2xl:-ml-4 2xl:-mt-10 cursor-pointer">
                <Image
                  ...
                  width={220}
                  height={90}
                  className="w-[140px] md:w-[170px] xl:w-[0px] 2xl:w-[250px] h-auto"
                />
              </div>

              <div className="flex justify-start -ml-16 mt-5 xl:gap-x-8 2xl:gap-x-12 2xl:-ml-15 2xl:-mt-10">
            ...
            {/* -------- ROW 2 -------- */}
            <div className="grid grid-cols-3 items-center h-[380px]">
              <div className="flex justify-start 2xl:ml-8">
                <Image
                  ...
                  width={260}
                  height={100}
                  className="w-[170px] md:w-[200px] xl:w-[191.74px] 2xl:w-[270px] h-auto"
                />
              </div>

              <div className="flex justify-start -ml-8 2xl:-ml-4">
                <Image
              ...
              <div className="flex justify-start -ml-17 2xl:-ml-16">
                <Image

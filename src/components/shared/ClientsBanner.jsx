...
const ClientsBanner = () => {
  ...
  const desktopClients = [
    {
      id: 1,
      image: "/assets/clientbanner-imgs/myro-test.webp",
      website: "https://myro.bot",
    },
    {
      id: 2,
      image: "/assets/clientbanner-imgs/goldstar-banner.webp",
      website: "https://goldstar.com",
    },
    {
      id: 3,
      image: "/assets/clientbanner-imgs/rabbit-banner.webp",
  ...
  const mobileClients = [
    {
      id: 1,
      image: "/assets/clientbanner-imgs/mobile-myro.webp",
      website: "https://myro.bot",
    },
    {
      id: 2,
      image: "/assets/clientbanner-imgs/mobile-goldstar.webp",
      website: "https://goldstar.com",
    },
    {
      id: 3,
      image: "/assets/clientbanner-imgs/mobile-rabbit.webp",
      website: "https://rabbitautocare.com",
    },
  ];
  ...
  useEffect(() => {
    ...
    preloadImage("/assets/clientbanner-imgs/header-badge.webp");
    
    // Preload background images
    preloadImage("/assets/clientbanner-imgs/client-bg.webp");
    preloadImage("/assets/clientbanner-imgs/client-mobile-bg.webp");
    ...
    preloadImage("/assets/clientbanner-imgs/pre-test.webp");
    preloadImage("/assets/clientbanner-imgs/next-test.webp");
    preloadImage("/assets/clientbanner-imgs/mobile-previous-btn.webp");
    preloadImage("/assets/clientbanner-imgs/mobile-next-btn.webp");
  }, []);
    ...
    <>
      ...
      <section className="hidden md:block relative w-full pt-10 pb-20 bg-[url('/assets/clientbanner-imgs/client-bg.webp')] bg-cover bg-center" id="clients">
        ...
        <div className="flex justify-center gap-6 mt-8">
          ...
          >
            <Image
              src="/assets/clientbanner-imgs/pre-test.webp"
              width={110}
              height={48}
              alt=""
          ...
          >
            <Image
              src="/assets/clientbanner-imgs/next-test.webp"
              width={110}
              height={48}
              alt=""
              className="client-blend-nav w-44 h-16"
      ...
      <section className="md:hidden min-h-screen bg-[url('/assets/clientbanner-imgs/client-mobile-bg.webp')] bg-cover bg-center flex flex-col pt-6 px-4 pb-16" id="clients">
        ...
        <div className="flex gap-3 mt-8 shrink-0">
          ...
          >
            <Image
              src="/assets/clientbanner-imgs/mobile-previous-btn.webp"
              width={180}
              height={44}
              alt=""
          ...
          >
            <Image
              src="/assets/clientbanner-imgs/mobile-next-btn.webp"
              width={180}
              height={44}
              alt=""
              className="client-blend-nav h-[50px] mx-auto"
